...
<body>
    ...
    <link rel="stylesheet" href="pages/admin_settings/style_adsettings.css">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="card-body" id="cards_body2" style="justify-content: center; background: white;">
                            ...
                            <h5 style="margin-top: 5px; margin-left: 30px; margin-bottom: -10px;">Change your privacy </h5>
                            
                            <h6 style="position: absolute; margin-top: -12px; margin-left: 912px; color: grey">Newest data appears first</h6>

                            <hr>

                            <img src="pages/account/GIF_SETTINGS.gif" style="width: 1.75in; height: 1in; margin-left: 465px;" id="bginfo_gif">
